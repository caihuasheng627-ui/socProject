// ============================================
// Lucide 图标库 (内嵌, 来源: lucide-static@1.24.0, ISC License)
// 7 大菜单 + 顶栏 + 按钮 + 状态图标
...
// 渲染 Lucide 图标为 SVG
// options: { size, color, strokeWidth }
// 注意: Lucide 是 stroke-only 图标,所以 fill="none"
window.renderLucide = function (name, options = {}) {
  const inner = window.LucideIcons[name];
  if (!inner) return '';
