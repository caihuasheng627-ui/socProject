...
const NEWS_FEED = [
  ...
  { id: 4, time: '2天前', source: 'Steam 公告', title: 'Dreams & Nightmares Case 掉宝率提升', summary: 'Valve 临时提升 D&N Case 掉宝率,箱子价格短期波动。', impact: '箱子价格波动', sentiment: 'neutral', url: 'https://store.steampowered.com/news/?appids=730', relatedSkins: ['case-dreams'] },
  ...
  { id: 6, time: '4天前', source: 'BUFF 公告', title: '交易手续费限时减免活动', summary: 'BUFF 推出限时交易手续费减免,提高市场活跃度。', impact: '整体利好', sentiment: 'positive', url: 'https://buff.163.com/', relatedSkins: [] },
];
...
// 涨跌榜数据
const TOP_GAINERS = [...SKINS_POOL].filter((a) => a.change7d > 0 && a.price >= 4).sort((a, b) => b.change7d - a.change7d).slice(0, 8);
const TOP_LOSERS = [...SKINS_POOL].filter((a) => a.change7d < 0 && a.price >= 4).sort((a, b) => a.change7d - b.change7d).slice(0, 8);
